...
$cta_text = $block_fields['bo_cta_text'];
$cta_link = $block_fields['bo_cta_link'];
$cta_icon = $block_fields['bo_cta_icon']; 
$background_color_cta = $block_fields['bo_cta_section_color'];
if($background_color_cta == "nocolor") { ?>
<div id="<?php echo $id; ?>" class="<?php echo $align_class.' '.$class_name;?>glide-block  scroll-color our-work-cta">
<?php }else{?>
